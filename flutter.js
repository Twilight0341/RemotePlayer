(() => {
  var L = () =>
    ...
    E = () => (typeof ImageDecoder > "u" ? !1 : L()),
    P = () => typeof Intl.v8BreakIterator < "u" && typeof Intl.Segmenter < "u",
    W = () => {
      let a = [0, 97, 115, 109, 1, 0, 0, 0, 1, 5, 1, 95, 1, 120, 0];
      return WebAssembly.validate(new Uint8Array(a));
    },
    w = {
      hasImageCodecs: E(),
      hasChromiumBreakIterators: P(),
      supportsWasmGC: W(),
      crossOriginIsolated: window.crossOriginIsolated,
    };
  function d(...a) {
    return new URL(_(...a), document.baseURI).toString();
  }
  function _(...a) {
    return a
      .filter((t) => !!t)
      .map((t, i) => (i === 0 ? S(t) : j(S(t))))
      .filter((t) => t.length)
      .join("/");
  }
  function j(a) {
    let t = 0;
    for (; t < a.length && a.charAt(t) === "/"; ) t++;
    return a.substring(t);
  }
  function S(a) {
    let t = a.length;
    for (; t > 0 && a.charAt(t - 1) === "/"; ) t--;
    return a.substring(0, t);
  }
  function T(a, t) {
    return a.canvasKitBaseUrl
      ? a.canvasKitBaseUrl
      : t.engineRevision && !t.useLocalCanvasKit
      ? _("https://www.gstatic.com/flutter-canvaskit", t.engineRevision)
      : "canvaskit";
  }
  var v = class {
    constructor() {
    ...
    async loadEntrypoint(t) {
      let {
        entrypointUrl: i = d("main.dart.js"),
    ...
    async load(t, i, r, e, n) {
      ...
      if (t.compileTarget === "dart2wasm")
        return this._loadWasmEntrypoint(t, i, s, n);
      {
    ...
    async _loadWasmEntrypoint(t, i, r, e) {
      if (!this._scriptLoaded) {
        ...
        let { mainWasmPath: n, jsSupportRuntimePath: s } = t,
          o = d(r, n),
          l = d(r, s);
        this._ttPolicy != null && (l = this._ttPolicy.createScriptURL(l));
        let c = (await import(l)).compileStreaming(fetch(o)),
          f;
        t.renderer === "skwasm"
          ? (f = (async () => {
          ...
          : (f = Promise.resolve({})),
          await (await (await c).instantiate(await f)).invokeMain();
      }
    }
  ...
  async function b(a, t, i) {
    ...
    return Promise.race([a, e]).finally(() => {
      clearTimeout(r);
    });
  }
  var y = class {
...
Read more: https://developer.mozilla.org/en-US/docs/Web/Security/Secure_Contexts`)),
      ...
      let {
          ...
          serviceWorkerUrl: r = d(`flutter_service_worker.js?v=${i}`),
          timeoutMillis: e = 4e3,
        } = t,
        n = r;
      ...
      return b(s, e, "prepareServiceWorker");
    }
        ...
        (this.policy = trustedTypes.createPolicy(i, {
          createScriptURL: function (e) {
            ...
            let n = new URL(e, window.location),
              s = n.pathname.split("/").pop();
            if (r.some((l) => l.test(s))) return n.toString();
            console.error(
  ...
  var k = (a) => {
    let t = WebAssembly.compileStreaming(fetch(a));
    return (i, r) => (
      (async () => {
        let e = await t,
  ...
  var I = (a, t, i, r) => (
    (window.flutterCanvasKitLoaded = (async () => {
      ...
      let n = e && t.canvasKitVariant !== "full",
        s = r;
      n && (s = d(s, "chromium"));
      let o = d(s, "canvaskit.js");
      a.flutterTT.policy && (o = a.flutterTT.policy.createScriptURL(o));
      let l = k(d(s, "canvaskit.wasm")),
        p = await import(o);
      return (
        (window.flutterCanvasKit = await p.default({ instantiateWasm: l })),
  ...
  var U = async (a, t, i, r) => {
    let e = d(r, "skwasm.js"),
      n = e;
    a.flutterTT.policy && (n = a.flutterTT.policy.createScriptURL(n));
    let s = k(d(r, "skwasm.wasm"));
    return await (
      await import(n)
    ).default({
      instantiateWasm: s,
  ...
  var C = class {
    async loadEntrypoint(t) {
      ...
      let s = new v();
      return (
        s.setTrustedTypesPolicy(e.policy),
    ...
    async load({
      ...
      let s = (u) => {
        ...
        l = (u) =>
          (u.compileTarget === "dart2wasm" && !w.supportsWasmGC) ||
          (e.renderer && !o(u, e.renderer))
            ? !1
            : s(u.renderer),
        p = n.builds.find(l);
      if (!p)
      ...
      (c.flutterTT = new g()),
        t &&
          ((c.serviceWorkerLoader = new y()),
          c.serviceWorkerLoader.setTrustedTypesPolicy(c.flutterTT.policy),
          await c.serviceWorkerLoader.loadServiceWorker(t).catch((u) => {
            console.warn("Exception while loading service worker:", u);
          }));
      let f = T(e, n);
      p.renderer === "canvaskit"
        ? (c.canvasKit = I(c, e, w, f))
        : p.renderer === "skwasm" && (c.skwasm = U(c, e, w, f));
      let h = new v();
      return (
        h.setTrustedTypesPolicy(c.flutterTT.policy),
        (this.didCreateEngineInitializer =
          h.didCreateEngineInitializer.bind(h)),
        h.load(p, c, e, r, i)
      );
    }
  };
